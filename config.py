...
class Config(BaseModel):
    ...
    MAX_EPISODE_STEPS: int = Field(default=6)  # spend longer on harder goals
    ...
    GAMMA: float = Field(default=0.8)  # coefficient on future q values
    DQN_MOMENTUM: float = Field(default=0.7)  # per episode
